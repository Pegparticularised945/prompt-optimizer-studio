...
- [快速开始](#快速开始)
- [常见问题](#常见问题)
- [Docker 自托管文档](docs/deployment/docker-self-hosted_ZH.md)
...
- [开源发布文案](docs/open-source-launch_ZH.md)
- [许可证](LICENSE)
...
完整部署说明见 [Docker 自托管文档](docs/deployment/docker-self-hosted_ZH.md)。
...
- 行为准则：[`CODE_OF_CONDUCT_ZH.md`](CODE_OF_CONDUCT_ZH.md)
